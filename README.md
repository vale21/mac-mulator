...
| Intel    | Mac OS X Lion | x86_64             | ⚠️ WORKING WITH ISSUES | Works in Beta 12 or later with no audio, no HVF and fixed screen resolution. As of Beta 12, the resolution selected in MacMulator is applied to the VM.     |
| Intel    | OS X Mountain Lion | x86_64             | ⚠️ WORKING WITH ISSUES | Works in Beta 12 or later with no audio, no HVF and fixed screen resolution. As of Beta 12, the resolution selected in MacMulator is applied to the VM.     |
| Intel    | OS X Mavericks | x86_64             | ⚠️ WORKING WITH ISSUES | Works in Beta 12 or later with no audio, no HVF, no networking and fixed screen resolution. As of Beta 12, the resolution selected in MacMulator is applied to the VM.     |
