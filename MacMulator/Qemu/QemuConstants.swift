...
class QemuConstants {
    ...
    static let vmDefaults = [
        ...
        [OS_MAC, SUB_MAC_MONTEREY, Utils.getPreferredArchitecture(), 6, 4096, 32768, 4096, 60, 8192, Utils.getPreferredDriveSize(), ICON_MONTEREY, Utils.getPreferredMachineType(), nil, true, NETWORK_VMXNET3, nil, URL_MAC_MONTEREY, MEDIATYPE_NVME, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_BIG_SUR, ARCH_X64, 4, 4096, 32768, 4096, 120, 8192, 250, ICON_BIG_SUR, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3, nil, URL_MAC_BIG_SUR, MEDIATYPE_NVME, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_CATALINA, ARCH_X64, 4, 2048, 32768, 4096, 120, 8192, 250, ICON_CATALINA, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3, nil, URL_MAC_CATALINA, MEDIATYPE_NVME, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_MOJAVE, ARCH_X64, 4, 2048, 32768, 4096, 120, 8192, 250, ICON_MOJAVE, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3, nil, URL_MAC_MOJAVE, MEDIATYPE_NVME, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_HIGH_SIERRA, ARCH_X64, 4, 2048, 32768, 4096, 120, 8192, 250, ICON_HIGH_SIERRA, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3, nil, URL_MAC_HIGH_SIERRA, MEDIATYPE_NVME, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_SIERRA, ARCH_X64, 4, 2048, 16384, 4096, 120, 8192, 250, ICON_SIERRA, MACHINE_TYPE_Q35, CPU_PENRYN_SSE, true, NETWORK_VMXNET3, nil, URL_MAC_SIERRA, MEDIATYPE_DISK, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_EL_CAPITAN, ARCH_X64, 4, 2048, 16384, 4096, 120, 8192, 250, ICON_EL_CAPITAN, MACHINE_TYPE_Q35, CPU_PENRYN, true, NETWORK_VMXNET3, nil, URL_MAC_EL_CAPITAN, MEDIATYPE_DISK, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_YOSEMITE, ARCH_X64, 4, 2048, 16384, 4096, 120, 8192, 250, ICON_YOSEMITE, MACHINE_TYPE_Q35, CPU_PENRYN, false, NETWORK_VMXNET3, nil, URL_MAC_YOSEMITE, MEDIATYPE_DISK, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_MAVERICKS, ARCH_X64, 4, 2048, 16384, 4096, 50, 4096, 120, ICON_MAVERICKS, MACHINE_TYPE_Q35, CPU_PENRYN, false, NETWORK_E1000_82545EM, nil, URL_MAC_MAVERICKS, MEDIATYPE_DISK, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_MOUNTAIN_LION, ARCH_X64, 4, 2048, 16384, 4096, 50, 4096, 120, ICON_MOUNTAIN_LION, MACHINE_TYPE_Q35, CPU_PENRYN, false, NETWORK_E1000, nil, URL_MAC_MOUNTAIN_LION, MEDIATYPE_DISK, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_LION, ARCH_X64, 4, 2048, 16384, 4096, 50, 4096, 120, ICON_LION, MACHINE_TYPE_Q35, CPU_PENRYN, false, NETWORK_E1000, nil, URL_MAC_LION, MEDIATYPE_DISK, false, VGA_VIRTIO, BOOT_UEFI],
        [OS_MAC, SUB_MAC_SNOW_LEOPARD, ARCH_X64, 2, 512, 8192, 1024, 10, 2048, 120, ICON_MAC_SNOW_LEOPARD, MACHINE_TYPE_Q35, CPU_PENRYN_SSE, false, NETWORK_E1000, nil, URL_MAC_SNOW_LEOPARD, MEDIATYPE_DISK, false, VGA_VIRTIO, BOOT_UEFI],
