...
class QemuConstants {
    ...
    static let vmDefaults = [
        ...
        [OS_WIN, SUB_WINDOWS_VISTA, ARCH_X64, 2, 1024, 32768, 2048, 120, 8192, 250, ICON_WINDOWS_VISTA, MACHINE_TYPE_Q35, CPU_PENRYN, true, NETWORK_E1000, SOUND_AC97, URL_WINDOWS_VISTA, MEDIATYPE_DISK],
