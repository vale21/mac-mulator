...
class QemuConstants {
    ...
    static let vmDefaults = [
        ...
        [OS_MAC, SUB_MAC_VENTURA, Utils.getPreferredArchitecture(), 6, 4096, 32768, 4096, 60, 8192, 120, ICON_VENTURA, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3],
        [OS_MAC, SUB_MAC_MONTEREY, Utils.getPreferredArchitecture(), 6, 4096, 32768, 4096, 60, 8192, 120, ICON_MONTEREY, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3],
        ...
        [OS_MAC, SUB_MAC_MOJAVE, ARCH_X64, 4, 2048, 32768, 4096, 120, 8192, 250, ICON_MOJAVE, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3],
        [OS_MAC, SUB_MAC_HIGH_SIERRA, ARCH_X64, 4, 2048, 32768, 4096, 120, 8192, 250, ICON_HIGH_SIERRA, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3],
        [OS_MAC, SUB_MAC_SIERRA, ARCH_X64, 4, 2048, 16384, 4096, 120, 8192, 250, ICON_SIERRA, MACHINE_TYPE_Q35, CPU_PENRYN_SSE, true, NETWORK_VMXNET3],
        [OS_MAC, SUB_MAC_EL_CAPITAN, ARCH_X64, 4, 2048, 16384, 4096, 120, 8192, 250, ICON_EL_CAPITAN, MACHINE_TYPE_Q35, CPU_PENRYN, true, NETWORK_VMXNET3],
        [OS_MAC, SUB_MAC_YOSEMITE, ARCH_X64, 4, 2048, 16384, 4096, 120, 8192, 250, ICON_YOSEMITE, MACHINE_TYPE_Q35, CPU_PENRYN, false, NETWORK_VMXNET3],
        [OS_MAC, SUB_MAC_MAVERICKS, ARCH_X64, 4, 2048, 16384, 4096, 50, 4096, 120, ICON_MAVERICKS, MACHINE_TYPE_Q35, CPU_PENRYN, false, NETWORK_E1000_82545EM],
        [OS_MAC, SUB_MAC_MOUNTAIN_LION, ARCH_X64, 4, 2048, 16384, 4096, 50, 4096, 120, ICON_MOUNTAIN_LION, MACHINE_TYPE_Q35, CPU_PENRYN, false, NETWORK_E1000],
        [OS_MAC, SUB_MAC_LION, ARCH_X64, 4, 2048, 16384, 4096, 50, 4096, 120, ICON_LION, MACHINE_TYPE_Q35, CPU_PENRYN, false, NETWORK_E1000],
        ...
        [OS_MAC, SUB_MAC_LEOPARD, ARCH_PPC, 1, 256, 3072, 512, 5, 500, 50, ICON_MAC_LEOPARD, MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        [OS_MAC, SUB_MAC_TIGER, ARCH_PPC, 1, 256, 3072, 512, 5, 500, 50, ICON_MAC_TIGER, MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        [OS_MAC, SUB_MAC_PANTHER, ARCH_PPC, 1, 128, 2048, 512, 5, 500, 50, ICON_MAC_PANTHER, MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        [OS_MAC, SUB_MAC_JAGUAR, ARCH_PPC, 1, 128, 2048, 256, 5, 500, 50, ICON_MAC_JAGUAR, MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        [OS_MAC, SUB_MAC_PUMA, ARCH_PPC, 1, 128, 2048, 256, 5, 500, 50, ICON_MAC_CHEETAH, MACHINE_TYPE_MAC99, nil, false, NETWORK_SUNGEM],
        [OS_MAC, SUB_MAC_CHEETAH, ARCH_PPC, 1, 128, 2048, 256, 5, 500, 50, ICON_MAC_CHEETAH, MACHINE_TYPE_MAC99, nil, false, NETWORK_SUNGEM],
        [OS_MAC, SUB_MAC_OS_9, ARCH_PPC, 1, 32, 1024, 64, 5, 500, 30, ICON_MAC_OS_9, MACHINE_TYPE_MAC99, nil, false, NETWORK_SUNGEM],
        [OS_MAC, SUB_MAC_OS_8, ARCH_PPC, 1, 32, 512, 32, 5, 500, 30, OS_MAC.lowercased(), MACHINE_TYPE_MAC99, nil, false, NETWORK_SUNGEM],
        [OS_MAC, SUB_SYSTEM_7, ARCH_68K, 1, 32, 512, 32, 5, 500, 30, OS_MAC.lowercased(), MACHINE_TYPE_Q800, nil, false, nil],
        [OS_WIN, SUB_WIN_GENERIC, ARCH_X64, 2, 1024, 32768, 2048, 120, 8192, 250, OS_WIN.lowercased(), MACHINE_TYPE_Q35, nil, true, nil],
        [OS_WIN, SUB_WINDOWS_11_ARM, ARCH_ARM64, 4, 2048, 32768, 2048, 250, 8192, 250, OS_WIN.lowercased(), MACHINE_TYPE_VIRT, nil, true, nil],
        [OS_WIN, SUB_WINDOWS_11, ARCH_X64, 2, 2048, 32768, 2048, 250, 8192, 250, OS_WIN.lowercased(), MACHINE_TYPE_Q35, nil, true, nil],
        [OS_WIN, SUB_WINDOWS_10_ARM, ARCH_ARM64, 4, 1024, 32768, 2048, 120, 8192, 250, ICON_WINDOWS_10, MACHINE_TYPE_VIRT, nil, true, nil],
        ...
        [OS_WIN, SUB_WINDOWS_XP, ARCH_X86, 1, 512, 3072, 1024, 120, 4096, 250, ICON_WINDOWS_XP, MACHINE_TYPE_PC, nil, false, NETWORK_VIRTIO_NET_PCI],
        [OS_WIN, SUB_WINDOWS_2000, ARCH_X86, 1, 512, 3072, 1024, 120, 4096, 250, OS_WIN.lowercased(), MACHINE_TYPE_PC, nil, false, NETWORK_VIRTIO_NET_PCI],
        [OS_WIN, SUB_WINDOWS_ME, ARCH_X86, 1, 256, 2048, 512, 20, 500, 120, OS_WIN.lowercased(), MACHINE_TYPE_PC, nil, false, NETWORK_VIRTIO_NET_PCI],
        [OS_WIN, SUB_WINDOWS_98, ARCH_X86, 1, 128, 1024, 256, 5, 500, 50, OS_WIN.lowercased(), MACHINE_TYPE_PC, nil, false, NETWORK_VIRTIO_NET_PCI],
        [OS_WIN, SUB_WINDOWS_NT, ARCH_X86, 1, 128, 1024, 256, 5, 500, 50, OS_WIN.lowercased(), MACHINE_TYPE_PC, nil, false, NETWORK_VIRTIO_NET_PCI],
        [OS_WIN, SUB_WINDOWS_95, ARCH_X86, 1, 2, 512, 32, 5, 500, 10, OS_WIN.lowercased(), MACHINE_TYPE_PC, nil, false, NETWORK_VIRTIO_NET_PCI],
        [OS_LINUX, SUB_LINUX_GENERIC, ARCH_X64, 2, 128, 32768, 1024, 30, 8192, 250, OS_LINUX.lowercased(), MACHINE_TYPE_Q35, nil, true, nil],
        [OS_LINUX, SUB_LINUX_GENERIC_ARM, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, OS_LINUX.lowercased(), MACHINE_TYPE_VIRT, nil, true, nil],
        [OS_LINUX, SUB_LINUX_GENERIC_PPC, ARCH_PPC, 1, 128, 2048, 512, 30, 8192, 250, OS_LINUX.lowercased(), MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        ...
        [OS_LINUX, SUB_LINUX_MINT_ARM, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, ICON_LINUX_MINT, MACHINE_TYPE_VIRT, nil, true, nil],
        [OS_LINUX, SUB_LINUX_MINT_PPC, ARCH_PPC, 1, 128, 2048, 512, 30, 8192, 250, ICON_LINUX_MINT, MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        [OS_LINUX, SUB_DEBIAN, ARCH_X64, 2, 128, 32768, 1024, 30, 8192, 250, ICON_DEBIAN, MACHINE_TYPE_Q35, nil, true, nil],
        [OS_LINUX, SUB_DEBIAN_ARM, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, ICON_DEBIAN, MACHINE_TYPE_VIRT, nil, true, nil],
        [OS_LINUX, SUB_DEBIAN_PPC, ARCH_PPC, 1, 128, 2048, 512, 30, 8192, 250, ICON_DEBIAN, MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        [OS_LINUX, SUB_UBUNTU, ARCH_X64, 2, 128, 32768, 1024, 30, 8192, 250, ICON_UBUNTU, MACHINE_TYPE_Q35, nil, true, nil],
        [OS_LINUX, SUB_UBUNTU_ARM, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, ICON_UBUNTU, MACHINE_TYPE_VIRT, nil, true, nil],
        [OS_LINUX, SUB_UBUNTU_PPC, ARCH_PPC, 1, 128, 2048, 512, 30, 8192, 250, ICON_UBUNTU, MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        ...
        [OS_LINUX, SUB_RASPBERRY_OS, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, OS_LINUX.lowercased(), MACHINE_TYPE_VIRT, nil, true, nil],
        ...
        [OS_OTHER, SUB_OTHER_x86, ARCH_X86, 1, 1, 3072, 512, 1, 8192, 120, OS_OTHER.lowercased(), MACHINE_TYPE_PC, nil, true, NETWORK_VIRTIO_NET_PCI],
        [OS_OTHER, SUB_OTHER_ARM_64, ARCH_ARM64, 2, 1, 32768, 2048, 1, 8192, 120, OS_OTHER.lowercased(), MACHINE_TYPE_VIRT, nil, true, nil],
        [OS_OTHER, SUB_OTHER_ARM, ARCH_ARM, 2, 1, 3072, 512, 1, 8192, 120, OS_OTHER.lowercased(), MACHINE_TYPE_VIRT, CPU_ARM1176, false, nil],
        [OS_OTHER, SUB_OTHER_PPC_64, ARCH_PPC64, 2, 1, 32768, 2048, 1, 8192, 120, OS_OTHER.lowercased(), MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        [OS_OTHER, SUB_OTHER_PPC, ARCH_PPC, 2, 1, 3072, 512, 1, 8192, 120, OS_OTHER.lowercased(), MACHINE_TYPE_MAC99_PMU, nil, false, NETWORK_SUNGEM],
        [OS_OTHER, SUB_OTHER_M68K, ARCH_68K, 1, 1, 512, 16, 1, 50, 5, OS_OTHER.lowercased(), MACHINE_TYPE_Q800, nil, false, nil]
    ]
