...
class QemuConstants {
    ...
    static let vmDefaults = [
        ...
        [OS_MAC, SUB_MAC_VENTURA, Utils.getPreferredArchitecture(), 6, 4096, 32768, 4096, 64, 8192, 120, ICON_VENTURA, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3],
        [OS_MAC, SUB_MAC_MONTEREY, Utils.getPreferredArchitecture(), 6, 4096, 32768, 4096, 64, 8192, 120, ICON_MONTEREY, MACHINE_TYPE_Q35, nil, true, NETWORK_VMXNET3],
