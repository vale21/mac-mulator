...
class QemuConstants {
    ...
    static let vmDefaults = [
        ...
        [OS_WIN, SUB_WINDOWS_7, ARCH_X64, 2, 1024, 32768, 2048, 120, 8192, 250, ICON_WINDOWS_7, MACHINE_TYPE_Q35, nil, true, nil, nil],
        ...
        [OS_LINUX, SUB_LINUX_GENERIC_ARM, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, OS_LINUX.lowercased(), MACHINE_TYPE_VIRT, nil, true, nil, nil],
        ...
        [OS_LINUX, SUB_LINUX_MINT_ARM, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, ICON_LINUX_MINT, MACHINE_TYPE_VIRT, nil, true, nil, nil],
        ...
        [OS_LINUX, SUB_DEBIAN_ARM, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, ICON_DEBIAN, MACHINE_TYPE_VIRT, nil, true, nil, nil],
        ...
        [OS_LINUX, SUB_UBUNTU_ARM, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, ICON_UBUNTU, MACHINE_TYPE_VIRT, nil, true, nil, nil],
        ...
        [OS_LINUX, SUB_RASPBERRY_OS, ARCH_ARM64, 2, 128, 32768, 1024, 30, 8192, 250, OS_LINUX.lowercased(), MACHINE_TYPE_VIRT, nil, true, nil, nil],
        ...
        [OS_OTHER, SUB_OTHER_ARM_64, ARCH_ARM64, 2, 1, 32768, 2048, 1, 8192, 120, OS_OTHER.lowercased(), MACHINE_TYPE_VIRT, nil, true, nil, nil],
