...
class QemuConstants {
    ...
    static let vmDefaults = [
        ...
        [OS_WIN, SUB_WINDOWS_11, Utils.getPreferredArchitecture(), 2, 1024, 32768, 2048, 120, 8192, 250, ICON_WINDOWS_11, Utils.getPreferredMachineType(), CPU_ICELAKE_SERVER, true, NETWORK_E1000, nil, URL_WINDOWS_11, MEDIATYPE_DISK, true],
