//
//  EditVMViewControllerGeneral.swift
//  MacMulator
//
...
class EditVMViewControllerGeneral: NSViewController, NSTableViewDataSource, NSTableViewDelegate, NSComboBoxDataSource, NSComboBoxDelegate, NSTextFieldDelegate, NSTextViewDelegate {
    ...
    @IBOutlet var bootOrderTable: NSTableView!
    @IBOutlet var resolutionTable: NSTableView!
    @IBOutlet var resolutionView: NSScrollView!
    @IBOutlet var resolutionLabelTop: NSTextField!
    @IBOutlet var resolutionlabelSide: NSTextField!
